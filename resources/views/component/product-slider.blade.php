                ...
                <div class="swiper mySwiper2 rounded-top-3" style="background-color: var(--first-color);">
                    <div class="swiper-wrapper text-center">
                        <div class="swiper-slide mt-1 rounded-3 overflow-hidden h-auto">
                            <img class="object-fit-contain" src="{{ asset("$product->image_url") }}" />
                        </div>
                        <div class="swiper-slide">
                            <img class="object-fit-contain" src="{{ asset('assets/img/product2.png') }}" />
                        </div>
                        <div class="swiper-slide">
                            <img class="object-fit-contain" src="{{ asset('assets/img/product3.png') }}" />
                        </div>
                        <div class="swiper-slide">
                            <img class="object-fit-contain" src="{{ asset('assets/img/product4.png') }}" />
                        </div>
                    </div>
                </div>
